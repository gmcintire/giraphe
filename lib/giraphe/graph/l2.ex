...
defmodule Giraphe.Graph.L2 do
  ...
  defp sort_adjacencies_by_upstream_polladdr_and_downlink(adjacencies) do
    downlinks =
      adjacencies
  ...
  defp get_adjacency_downlink({down = _downstream_switch, up = _upstream_switch}),
  ...
  defp unique_adjacencies_by_topologically_closest_switches(adjacencies) do
  ...
  defp _abduce_adjacencies(switches) do
    for down = _downstream_switch <- switches,
        ...
        physaddr_in_fdb?(up.fdb, down.physaddr) do
      {down, up}
    end
  ...
  def abduce_adjacencies(switches) do
    ...
    prepped_switches = prepare_switches_for_adjacency_abduction(switches)
