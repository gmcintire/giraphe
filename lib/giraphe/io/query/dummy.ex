...
defmodule Giraphe.IO.Query.Dummy do
  ...
  defp _query_addresses("192.0.2.7") do
    ["192.0.2.7/31", "192.0.2.10/31", "198.51.100.25/29", "198.51.100.33/29"]
  end
  ...
  defp _query_addresses(target)
    ...
    ["192.0.2.3/31", "192.0.2.8/31"]
  end

  defp _query_addresses("192.0.2.9") do
    ["192.0.2.13/30", "192.0.2.9/31", "192.0.2.11/31", "192.0.2.5/31"]
  end

  defp _query_addresses("192.0.2.1") do
    ["192.0.2.1/31", "198.51.100.1/29"]
  end
  ...
  defp _query_addresses("203.0.113.10") do
    ["203.0.113.10/32", "203.0.113.12/31"]
  end

  defp _query_addresses("203.0.113.11") do
    ["203.0.113.11/32", "203.0.113.13/31"]
  end
  ...
  defp _query_routes("203.0.113.14") do
    [{"203.0.113.14/31", "203.0.113.14"}, {"203.0.113.14/32", "127.0.0.1"}]
  end
